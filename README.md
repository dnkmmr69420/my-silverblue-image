...
[![build-ublue](https://github.com/ublue-os/startingpoint/actions/workflows/build.yml/badge.svg)](https://github.com/dnkmmr69420/my-silverblue-image/actions/workflows/build.yml)
...
```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/dnkmmr69420/custom-silverblue-image:latest
```
